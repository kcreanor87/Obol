...
public class TurretDatabase: MonoBehaviour{
	...
	void Awake(){
		_turretDatabase.Add(new Turret(600, "Machine Gun", 15.0f, 10, 0.5f, 100, 0, true, 0.0f, 0));
		_turretDatabase.Add(new Turret(601, "Burst", 10f, 200, 0.8f, 200, 1, true, 0.0f, 1));
		...
		_turretDatabase.Add(new Turret(605, "Blaster", 10.0f, 220, 1.5f, 200, 0, true, 0.0f, 0));
	}
}
